            ...
            <div class="container">
              <div class="columns is-vcentered is-desktop">
                <div class="column is-vcentered has-text-centered">
                  <div
                    class="is-family-monospace is-size-1 is-inline-block has-text-centered"
                  >
                    <span
                      class="mx-5 py-2 is-vcentered animate__animated animate__bounce animate__delay-1s"
                    >
                      <g-image
          ...
          <section class="section">
            <div class="container has-text-centered">
              <div class="tile is-ancestor">
                <div class="tile is-parent">
                  <article class="tile is-child kc-card">
                    <p class="kc-card__title">Sourcegain</p>
                    <div
                    ...
                    >
                      <div class="control">
                        <div class="tags has-addons">
                          ...
                          <span class="tag is-light">Material Design</span>
                        </div>
                      </div>
                      ...
                      <div class="control">
                        <div class="tags has-addons">
                          ...
                          <span class="tag is-warning">v5</span>
                        </div>
                      </div>
                      ...
                      <div class="control">
                        <div class="tags has-addons">
                          ...
                          <span class="tag is-info">v3</span>
                        </div>
                      </div>
                    ...
                    <g-image src="~/assets/images/sourcegain.png" />
                    <b-button
                      class="my-3"
                      tag="a"
                      href="https://sourcegain.com/"
                      type="is-dark"
                      >Visit</b-button
                    >
                  </article>
                ...
                <div class="tile is-parent">
                  <article class="tile is-child kc-card">
                    <p class="kc-card__title">Envelope</p>
                    <div
                      class="field is-grouped is-grouped-multiline px-3 py-2"
                    >
                      <div class="control">
                        <div class="tags has-addons">
                          ...
                          <span class="tag is-warning">v3.8</span>
                        </div>
                      </div>
              ...
              <div class="tile is-ancestor">
                <div class="tile is-parent">
                  <article class="tile is-child kc-card">
                    <h3 class="kc-card__title">Amazing Workplaces</h3>
                    <div
                      class="field is-grouped is-grouped-multiline px-3 py-2"
                    >
                      <div class="control">
                        <div class="tags has-addons">
                          ...
                          <span class="tag is-info">v7</span>
                        </div>
                      </div>
                      ...
                      <div class="control">
                        <div class="tags has-addons">
                          ...
                          <span class="tag is-info">4.0</span>
                        </div>
                      </div>
                      ...
                      <div class="control">
                        <div class="tags has-addons">
                          ...
                          <span class="tag is-primary">v4.0</span>
                        </div>
                      </div>
                    ...
                    <g-image src="~/assets/images/awp.png" />

                    <b-button
                      class="my-3"
                      tag="a"
                      href="https://amazingworkplaces.co.in/"
                      type="is-dark"
                      >Visit</b-button
                    >
                  </article>
              ...
              <div class="tile is-ancestor">
                <div class="tile is-parent">
                  <article class="tile is-child kc-card">
                    <h3 class="kc-card__title">Perfectgration.com</h3>
                    <div
                      class="field is-grouped is-grouped-multiline px-3 py-2"
                    >
                      <div class="control">
                        <div class="tags has-addons">
                          <span class="tag is-dark">Python</span>
                          <span class="tag is-info">v3.8</span>
                        </div>
                      </div>
                      ...
                      <div class="control">
                        <div class="tags has-addons">
                          <span class="tag is-dark">Django</span>
                          <span class="tag is-success">3.0.5</span>
                        </div>
                      </div>
                    ...
                    <g-image src="~/assets/images/perfectgration.png" />

                    <b-button
                      class="my-3"
                      tag="a"
                      href="https://perfectgration.com/"
                      type="is-dark"
                    >
                      Visit
                    </b-button>
